...
const Gallery = () => {
  ...
  const images = [
    ...
    { src: gym5, title: 'Cricket Nets', category: 'Cricket' },
    { src: gym6, title: 'Football Field', category: 'Football' },
          ...
          <Tab.Group selectedIndex={selectedTab} onChange={setSelectedTab}>
            <ScrollAnimation>
              <Tab.List className="flex space-x-4 bg-gray-100 p-1 rounded-lg mb-12 max-w-md mx-auto">
                <Tab
                  className={({ selected }) =>
                    `w-full py-3 text-center rounded-md font-medium transition-all ${
                      selected
